...
const ShowPending = ({ showPending, onButtonClick }) => {
  return (
    <>
      <div
        className={`send-tokens-window-pending ${showPending ? "" : "hide"}`}
      >
        ...
        <div className="send-tokens-window-pending-header">
          Transaction pending
        </div>
        <div className="send-tokens-window-pending-copy">
          The transaction is now pending, navigate to the Pending Minidapp on your MiniHub to accept it.
        </div>        
        <button
