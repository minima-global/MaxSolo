    ...
    if (contactData == "") {
      ...
      window.MDS.cmd(addcontact, function (resp) {
        if (resp.status) {
          ...
          setInfoNotifyText(
            "This address is not valid. Please ask your contact to send it again and enter it within a 10 minute window."
          );
          setTimeout(() => {
            setInfoNotifyText("");
          }, 3000);
      ...
      <div className="maxsolo-sidebar-container-content">
        ...
        <form onSubmit={addContact}>
          <textarea
            ...
            type="text"
            placeholder="@185.209.230.202:9001"
            value={contactData}
